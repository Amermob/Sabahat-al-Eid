...
const translations = {
  ...
  ar: {
    ...
    english: "English",
    summery:
      "نتشرف نحن شركة صباحات العيد للمقاولات بالقيام باعمال الهدم و لدينا فريق متخصص و ذو خبره في اعمال الهدم واخذ اعلى وسائل السلامه و عدم الاضرار بالمباني المجاوره لاعمال الهدم بأحترافية نقدم تقييم للمخلفات منافس عن السوق نتشرف بتواصلكم 0555931369 واتس اب او اتصال كما لدينا المعدات الممكنة لانجاز العمل بأسرع وقت نفخر بانجازتنا بعد رضاكم عن اعمالنا ",
    whatWeDo:
    ...
    location: "صهيب بن سينان، العريجا الغربي الرياض",
  },
};
